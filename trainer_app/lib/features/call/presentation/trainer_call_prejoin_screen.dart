...
import 'trainer_call_screen.dart';

class TrainerCallPrejoinScreen extends ConsumerWidget {
  const TrainerCallPrejoinScreen({super.key});
  ...
  Future<void> _joinMeeting(BuildContext context, WidgetRef ref) async {
    ...
    try {
      ...
      await navigator.push(
        MaterialPageRoute<void>(builder: (_) => const TrainerCallScreen()),
      );
    } catch (error) {
